...
requirements:
  ...
  InitialWorkDirRequirement:
    ...
    - entryname: inputs.json
      entry: '{"inputs": $(inputs)}'
label: Demultiplex paired-end sequence data generated with the EMP protocol.
doc: Demultiplex paired-end sequence data (i.e., map barcode reads to sample ids)
  for data generated with the Earth Microbiome Project (EMP) amplicon sequencing protocol.
  Details about this protocol can be found at http://www.earthmicrobiome.org/protocols-and-standards/
inputs:
  seqs:
