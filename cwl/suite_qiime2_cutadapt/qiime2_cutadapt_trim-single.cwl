...
id: qiime2_cutadapt_trim_single
requirements:
  EnvVarRequirement:
    envDef:
      LC_ALL: en_US.UTF-8
  ...
  InitialWorkDirRequirement:
    ...
    - entryname: inputs.json
      entry: '{"inputs": $(inputs)}'
label: Find and remove adapters in demultiplexed single-end sequences.
doc: Search demultiplexed single-end sequences for adapters and remove them. The parameter
