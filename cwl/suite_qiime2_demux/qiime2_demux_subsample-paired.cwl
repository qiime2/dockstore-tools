...
id: qiime2_demux_subsample_paired
requirements:
  EnvVarRequirement:
    envDef:
      LC_ALL: en_US.UTF-8
  ...
  InitialWorkDirRequirement:
    ...
    - entryname: inputs.json
      entry: '{"inputs": $(inputs)}'
label: Subsample paired-end sequences without replacement.
doc: Generate a random subsample of paired-end sequences containing approximately
