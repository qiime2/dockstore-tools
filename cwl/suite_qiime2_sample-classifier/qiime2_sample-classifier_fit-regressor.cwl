...
id: qiime2_sample_classifier_fit_regressor
requirements:
  EnvVarRequirement:
    envDef:
      LC_ALL: en_US.UTF-8
  ...
  InitialWorkDirRequirement:
    ...
    - entryname: inputs.json
      entry: '{"inputs": $(inputs)}'
label: Fit a supervised learning regressor.
doc: Fit a supervised learning regressor. Outputs the fit estimator (for prediction
