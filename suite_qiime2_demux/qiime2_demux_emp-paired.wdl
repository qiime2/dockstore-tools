...
struct qiime2_demux_emp_paired_params {
    File seqs
    String barcodes
...
task qiime2_demux_emp_paired {
    ...
    qiime2_demux_emp_paired_params task_params = object {
        seqs: seqs,
        barcodes: barcodes,
    ...
    command {
        q2dataflow q2wdl run demux emp_paired ~{write_json(task_params)}
    }
...
workflow wkflw_qiime2_demux_emp_paired {
input {
        File seqs
        String barcodes
        File q2wdl_metafile_barcodes
