...
id: qiime2_dada2_denoise_single
requirements:
  EnvVarRequirement:
    envDef:
      LC_ALL: en_US.UTF-8
  ...
  InitialWorkDirRequirement:
    ...
    - entryname: inputs.json
      entry: '{"inputs": $(inputs)}'
label: Denoise and dereplicate single-end sequences
doc: This method denoises single-end sequences, dereplicates them, and filters chimeras.
inputs:
  demultiplexed_seqs:
