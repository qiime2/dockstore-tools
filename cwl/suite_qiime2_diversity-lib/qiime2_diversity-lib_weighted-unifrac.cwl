...
id: qiime2_diversity_lib_weighted_unifrac
requirements:
  EnvVarRequirement:
    envDef:
      LC_ALL: en_US.UTF-8
...
doc: Compute Weighted Unifrac for each sample in a feature table
inputs:
  table:
    doc: The feature table containing the samples for which Weighted Unifrac should
      be computed.
    type: File
  phylogeny:
