...
struct qiime2_dada2_denoise_paired_params {
...
task qiime2_dada2_denoise_paired {
    ...
    qiime2_dada2_denoise_paired_params task_params = object {
    ...
    command {
        q2dataflow q2wdl run dada2 denoise_paired ~{write_json(task_params)}
    }
...
workflow wkflw_qiime2_dada2_denoise_paired {
input {
        File demultiplexed_seqs
        Int trunc_len_f
        Int trunc_len_r
