...
struct qiime2_dada2_denoise_pyro_params {
...
task qiime2_dada2_denoise_pyro {
    ...
    qiime2_dada2_denoise_pyro_params task_params = object {
    ...
    command {
        q2dataflow q2wdl run dada2 denoise_pyro ~{write_json(task_params)}
    }
...
workflow wkflw_qiime2_dada2_denoise_pyro {
input {
        File demultiplexed_seqs
        Int trunc_len
        Int trim_left = 0
    ...
    call qiime2_dada2_denoise_pyro {
